        ...
        <div className="space-y-16">
          ...
          <article className="max-w-5xl mx-auto space-y-10">
            <div className="prose prose-invert max-w-none">
              ...
              <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 mt-18 items-stretch">
                {marketInsights && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto w-full py-10 md:py-12">
