...
export default function NetworkStatus() {
  ...
  return (
    <AnimatePresence>
      {(isOffline || showResolved || isQuotaExceeded) && (
        <motion.div
          ...
          style={{ left: '50%' }}
          className={`fixed bottom-6 z-[999] px-6 py-3.5 rounded-[12px] border shadow-2xl backdrop-blur-xl flex items-center justify-center gap-3 max-w-md w-[calc(100%-2rem)] ${
            isQuotaExceeded 
