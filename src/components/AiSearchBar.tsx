...
export function AiSearchBar({ isLoading }: AiSearchBarProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 md:gap-4 w-full">
      <div className="w-full md:flex-1 h-[60px] md:h-[76px] bg-[#13212e]/60 backdrop-blur-3xl border border-white/10 rounded-[14px] flex items-center px-3 md:px-4 shadow-2xl transition-all duration-300 hover:border-secondary focus-within:border-secondary hover:bg-[#192735]/80 group">
        {/* Mobile Input */}
        <input
          type="text"
          ...
          className="w-full h-full md:hidden !bg-transparent !border-none !backdrop-blur-none !outline-none !ring-0 !shadow-none focus:!outline-none focus:!ring-0 focus:!shadow-none focus-visible:!outline-none focus-visible:!ring-0 text-white placeholder:text-white/40 text-sm font-bold tracking-wide px-3 text-center"
        />
        {/* Desktop Input */}
        <input
          type="text"
