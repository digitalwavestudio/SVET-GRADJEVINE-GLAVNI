import { useMemo, memo, Suspense, lazy, useRef } from 'react';
        ...
        <motion.div variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 }}} className="md:col-span-3 h-fit">
           <Card padding="lg" layout="default" className="h-fit">
              <div className="flex flex-col sm:flex-row gap-4 justify-between sm:items-center mb-10 shrink-0">
                ...
                <Link to="/moj-profil/prijave" className="bg-secondary !text-black font-black px-8 py-3 rounded-[10px] text-[10px] tracking-widest uppercase hover:bg-yellow-400 transition-all text-center">POGLEDAJ SVE PRIJAVE</Link>
              </div>
