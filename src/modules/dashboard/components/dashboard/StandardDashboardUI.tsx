...
const StandardDashboardUI = memo(function StandardDashboardUI() {
  ...
  return (
    ...
    >
      <motion.div variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 }}} className="bg-[#0A0F14] border border-white/5 rounded-[10px] px-4 py-8 md:px-16 md:py-16 relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-6xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-7xl font-black text-white uppercase tracking-tighter mb-6 leading-[1.15] tracking-[-0.05em]">KONTROLNA TABLA, <span className="text-secondary">VAŠ POČETAK</span></h2>
          ...
          <Link 
            ...
            className="relative block w-full bg-gradient-to-br from-[#0F1621] to-[#05080C] border-2 border-secondary/30 rounded-[16px] p-4 md:p-12 overflow-hidden group transition-all duration-500 hover:border-secondary hover:shadow-[0_0_50px_rgba(254,191,13,0.15)]"
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-5 text-center md:flex-row md:items-center md:text-left md:justify-between md:gap-8">
              <div className="flex flex-col items-center gap-4 md:flex-row md:gap-6">
                ...
                <div className="space-y-3 md:space-y-2">
                  <div className="hidden md:inline-flex items-center gap-2 px-3 py-1 bg-secondary/10 border border-secondary/25 rounded-full">
                    ...
                    <span className="text-[9px] font-black text-secondary uppercase tracking-[0.2em]">JEDAN NALOG. SVE PROFESIONALNE MOGUĆNOSTI PLATFORME.</span>
                  </div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-white uppercase tracking-tighter leading-none">
                    AKTIVIRAJTE SVOJU <span className="text-secondary">PRO ULOGU</span>
                  </h3>
                  <p className="text-xs sm:text-sm md:text-[11px] font-bold text-white/50 uppercase tracking-wider leading-relaxed max-w-xl">
                    Postanite registrovani član i pristupite svim profesionalnim funkcijama i mogućnostima platforme.
                  </p>
                </div>
              </div>
              <div className="shrink-0 w-full md:w-auto flex justify-center">
                <div className="w-full md:w-auto px-8 py-4 bg-secondary !text-black font-black rounded-[10px] text-xs tracking-[0.2em] uppercase transition-all duration-300 shadow-xl shadow-secondary/10 group-hover:bg-yellow-400 group-hover:shadow-secondary/25 flex items-center justify-center gap-2">
                  ZAPOČNI
