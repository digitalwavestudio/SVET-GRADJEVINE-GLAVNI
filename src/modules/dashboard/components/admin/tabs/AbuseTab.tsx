...
import { useAdminAbuse } from '@/src/modules/admin/hooks/useAdminAbuse';
...
export function AbuseTab() {
  ...
  const suspendUser = async (userId: string) => {
    ...
    try {
      ...
      toast.success('Korisnik je suspendovan.');
    } catch (e: any) {
      const appErr = e as { response?: { data?: { error?: string } }; message?: string };
      toast.error(appErr?.response?.data?.error || appErr.message || 'Greška pri suspenziji');
      console.error(e);
    }
  };
