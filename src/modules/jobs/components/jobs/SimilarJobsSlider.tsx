...
export function SimilarJobsSlider({ jobData, displaySimilarJobs, buildJobUrl }: SimilarJobsSliderProps) {
  ...
  const renderBadge = (job: any) => {
    ...
    if (job.isUrgent) return <span className="backdrop-blur-sm bg-[#ff512f]/10 text-[#ff512f] border border-[#ff512f]/20 px-2.5 py-1 rounded-[8px] text-[9px] font-black uppercase tracking-widest shadow-[0_0_12px_rgba(255,81,47,0.2)]">Hitno</span>;
