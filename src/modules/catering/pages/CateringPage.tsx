...
import { FilterSidebar, FilterClearButton, FilterSection, FilterToggle, FilterRadio, FilterSelect, FilterInput, FilterCTA, MarketStatsWidget, SortingBar, ViewToggle } from '@/src/modules/core/components/filters/FilterComponents';
    ...
    <div className="bg-surface text-on-surface font-body selection:bg-secondary selection:text-on-secondary min-h-screen">
      ...
      >
        <div className="mt-8 flex flex-col gap-4 max-w-4xl w-full">
          <AiSearchBar vertical="catering" />
        </div>
      </StandardPageHero>

      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12 flex flex-col-reverse lg:flex-row-reverse gap-12">
