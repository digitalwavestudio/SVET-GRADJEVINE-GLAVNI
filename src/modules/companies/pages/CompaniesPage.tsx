        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4 max-w-4xl">
          <div className="flex-1 bg-[#13212e]/40 backdrop-blur-3xl border border-white/5 rounded-[10px] flex items-center pl-8 p-1 shadow-3xl transition-all focus-within:border-secondary/50 focus-within:bg-[#192735]/60 hover:bg-[#192735]/40 group">
            ...
            <input
              ...
              placeholder="PRETRAŽI PO NAZIVU ILI DELATNOSTI..."
                        ...
                        <div className="relative px-5 pb-5 flex flex-col flex-grow -mt-8 z-10">
                          <div className="flex items-end gap-4 mb-4">
                            ...
                            <div className="flex-1 pb-1">
                              ...
                              {company.isVerified ? (
                                <div className="flex flex-col gap-1.5 mt-2 group/badges relative">
                                  <div className="flex items-center gap-1 bg-[#0A1A0F]/80 border border-green-500/20 backdrop-blur-xl px-1.5 py-0.5 rounded-[4px] w-fit shadow-[0_0_15px_rgba(34,197,94,0.1)]">
                                  ...
                                  {company.licences && company.licences.length > 0 && (
                                    <div className="relative z-20">
                                      <div className="flex items-center gap-1 bg-[#0A1A0F]/80 border border-green-500/20 backdrop-blur-xl px-1.5 py-0.5 rounded-[4px] w-fit shadow-[0_0_15px_rgba(34,197,94,0.1)] cursor-help peer">
