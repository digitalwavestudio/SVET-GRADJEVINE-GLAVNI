...
export const Sidebar = memo(({ 
  ...
  return (
    <aside className={`w-64 bg-[#0A0F14] border-r border-white/5 flex flex-col fixed inset-y-0 left-0 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:sticky md:top-0 h-[100dvh] z-50 transition-transform duration-300 ease-in-out`}>
