        ...
        <div className={`relative z-10 max-w-7xl mx-auto px-4 md:px-8 w-full transition-all duration-[650ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
          ...
          >
            ...
            <div className={`transition-all duration-[550ms] ease-[cubic-bezier(0.16,1,0.3,1)] origin-top ${
              ...
              <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl font-[1000] md:font-[950] text-white leading-[0.85] tracking-[-0.05em] uppercase relative mb-8">
                SVE ZA GRAĐEVINU
                <div>
                  <span className="text-secondary">NA JEDNOM MESTU</span>
                </div>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-slate-200 max-w-4xl font-medium leading-relaxed relative">
