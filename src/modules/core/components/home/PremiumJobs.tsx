            ...
            <div className="flex gap-8 animate-[scroll_60s_linear_infinite] hover:[animation-play-state:paused] w-max">
              {Array(4).fill(premiumJobs).flat().map((job: any, idx: number) => {
                ...
                <Link 
                  ...
                  className="gold-glow bg-gradient-to-b from-yellow-500/20 to-transparent p-[2px] rounded-[10px] group/card relative block shrink-0 w-[85vw] min-w-[270px] sm:min-w-[340px] md:min-w-[620px] md:w-[620px] cursor-pointer h-[380px] md:h-[340px]"
                >
                      ...
                      <div className="flex-1 min-w-0 font-sans text-left">
                        <div className="flex flex-wrap items-center gap-2 mb-1.5 relative z-10">
                          <div className="flex items-center gap-1 animate-blink">
                            ...
                            <span className="text-yellow-500 text-[10px] md:text-xs font-black uppercase tracking-widest">
