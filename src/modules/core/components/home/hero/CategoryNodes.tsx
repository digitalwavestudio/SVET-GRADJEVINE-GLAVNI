          ...
          return (
            ...
            >
              {['alat-i-oprema', 'masine', 'placevi'].includes(tab.id) && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 pointer-events-none opacity-0 group-hover/tooltip:opacity-100 group-active/tooltip:opacity-100 transition-all duration-300 scale-95 group-hover/tooltip:scale-100 group-active/tooltip:scale-100 z-50 w-max md:hidden">
      ...
      <div className="hidden">
        {HERO_TABS.map((tab, idx) => {
          ...
          return (
            ...
            >
              {['alat-i-oprema', 'masine', 'placevi'].includes(tab.id) && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 pointer-events-none opacity-0 group-hover/tooltip:opacity-100 transition-all duration-300 scale-90 group-hover/tooltip:scale-100 z-50 w-max hidden md:block">
                  <div className="bg-[#0b131a]/95 backdrop-blur-md border border-white/10 p-4 md:p-5 rounded-[12px] shadow-[0_8px_30px_rgba(0,0,0,0.5)] whitespace-nowrap md:min-w-[260px] flex flex-col items-start text-left">
                    ...
                    <p className="text-white/90 text-[12px] md:text-[13px] font-medium tracking-wide">Ova sekcija stiže uskoro, još uvek je u izradi!</p>
                  </div>
                </div>
              )}
