export const UI_TOKENS = {
  ...
  PREMIUM_CARD_INNER: "bg-[#0F1923] flex flex-col md:flex-row gap-6 md:gap-7 items-center rounded-[10px] border border-white/5 h-full",
  ...
  FORM_INPUT: "w-full bg-[#0F1923] border border-white/10 rounded-[10px] p-6 text-white text-lg font-medium outline-none focus:border-secondary/50 focus:ring-4 focus:ring-secondary/5 transition-all"
};
