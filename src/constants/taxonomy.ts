...
export const LOCATIONS: TaxonomyItem[] = [
  ...
  { id: 'bec', slug: 'bec', name: 'Beč' },
  { id: 'grac', slug: 'grac', name: 'Grac' },
  { id: 'linz', slug: 'linz', name: 'Linz' },
  { id: 'salzburg', slug: 'salzburg', name: 'Salzburg' },
  { id: 'hrvatska', slug: 'hrvatska', name: 'Hrvatska' },
  { id: 'zagreb', slug: 'zagreb', name: 'Zagreb' },
  { id: 'split', slug: 'split', name: 'Split' },
  { id: 'rijeka', slug: 'rijeka', name: 'Rijeka' },
  { id: 'osijek', slug: 'osijek', name: 'Osijek' },
  { id: 'zadar', slug: 'zadar', name: 'Zadar' },
  { id: 'pula', slug: 'pula', name: 'Pula' },
  { id: 'dubrovnik', slug: 'dubrovnik', name: 'Dubrovnik' },
  { id: 'slovenija', slug: 'slovenija', name: 'Slovenija' },
  { id: 'ljubljana', slug: 'ljubljana', name: 'Ljubljana' },
  { id: 'maribor', slug: 'maribor', name: 'Maribor' },
  { id: 'celje', slug: 'celje', name: 'Celje' },
  { id: 'koper', slug: 'koper', name: 'Koper' },
  { id: 'crna-gora', slug: 'crna-gora', name: 'Crna Gora' },
  { id: 'podgorica', slug: 'podgorica', name: 'Podgorica' },
  { id: 'niksic', slug: 'niksic', name: 'Nikšić' },
  { id: 'bar', slug: 'bar', name: 'Bar' },
  { id: 'budva', slug: 'budva', name: 'Budva' },
  { id: 'tivat', slug: 'tivat', name: 'Tivat' },
  ...
  { id: 'doboj', slug: 'doboj', name: 'Doboj' },
  { id: 'prijedor', slug: 'prijedor', name: 'Prijedor' },
  { id: 'trebinje', slug: 'trebinje', name: 'Trebinje' },
