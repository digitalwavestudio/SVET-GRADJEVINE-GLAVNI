...
export const LOCATIONS: TaxonomyItem[] = [
  ...
  { id: 'smederevo', slug: 'smederevo', name: 'Smederevo' },
  { id: 'zrenjanin', slug: 'zrenjanin', name: 'Zrenjanin' },
  { id: 'valjevo', slug: 'valjevo', name: 'Valjevo' },
  { id: 'pozarevac', slug: 'pozarevac', name: 'Požarevac' },
  { id: 'jagodina', slug: 'jagodina', name: 'Jagodina' },
  { id: 'loznica', slug: 'loznica', name: 'Loznica' },
  { id: 'pirot', slug: 'pirot', name: 'Pirot' },
  { id: 'zajecar', slug: 'zajecar', name: 'Zaječar' },
  { id: 'bor', slug: 'bor', name: 'Bor' },
  { id: 'sremska-mitrovica', slug: 'sremska-mitrovica', name: 'Sremska Mitrovica' },
  { id: 'kikinda', slug: 'kikinda', name: 'Kikinda' },
  { id: 'sombor', slug: 'sombor', name: 'Sombor' },
  { id: 'vrsac', slug: 'vrsac', name: 'Vršac' },
  { id: 'ruma', slug: 'ruma', name: 'Ruma' },
  { id: 'backa-palanka', slug: 'backa-palanka', name: 'Bačka Palanka' },
  { id: 'vrbas', slug: 'vrbas', name: 'Vrbas' },
  { id: 'prokuplje', slug: 'prokuplje', name: 'Prokuplje' },
  ...
  { id: 'berlin', slug: 'berlin', name: 'Berlin' },
  { id: 'munchen', slug: 'munchen', name: 'München' },
  { id: 'hamburg', slug: 'hamburg', name: 'Hamburg' },
  { id: 'frankfurt', slug: 'frankfurt', name: 'Frankfurt' },
  { id: 'stuttgart', slug: 'stuttgart', name: 'Stuttgart' },
  { id: 'koln', slug: 'koln', name: 'Köln' },
  { id: 'dortmund', slug: 'dortmund', name: 'Dortmund' },
  { id: 'leipzig', slug: 'leipzig', name: 'Leipzig' },
  { id: 'dresden', slug: 'dresden', name: 'Dresden' },
  { id: 'bremen', slug: 'bremen', name: 'Bremen' },
  { id: 'hannover', slug: 'hannover', name: 'Hannover' },
  { id: 'nuernberg', slug: 'nuernberg', name: 'Nürnberg' },
  { id: 'duesseldorf', slug: 'duesseldorf', name: 'Düsseldorf' },
  ...
  { id: 'bosna-i-hercegovina', slug: 'bosna-i-hercegovina', name: 'Bosna i Hercegovina' },
  { id: 'sarajevo', slug: 'sarajevo', name: 'Sarajevo' },
  { id: 'banja-luka', slug: 'banja-luka', name: 'Banja Luka' },
  { id: 'tuzla', slug: 'tuzla', name: 'Tuzla' },
  { id: 'mostar', slug: 'mostar', name: 'Mostar' },
  { id: 'bijeljina', slug: 'bijeljina', name: 'Bijeljina' },
  { id: 'zenica', slug: 'zenica', name: 'Zenica' },
  { id: 'severna-makedonija', slug: 'severna-makedonija', name: 'Severna Makedonija' },
  { id: 'skopje', slug: 'skopje', name: 'Skoplje' },
  { id: 'rumunija', slug: 'rumunija', name: 'Rumunija' },
  { id: 'temisvar', slug: 'temisvar', name: 'Temišvar' },
