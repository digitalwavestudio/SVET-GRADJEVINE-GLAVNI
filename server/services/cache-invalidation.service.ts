...
export class CacheInvalidationService {
  ...
  static async onAdChange(category: string, uid: string): Promise<void> {
    const prefixes = [
      ...
      CACHE_PREFIXES.SWR_ENVELOPE + CACHE_PREFIXES.PROMOTED,
      CACHE_PREFIXES.PUBLIC_ADS,
      CACHE_PREFIXES.SWR_ENVELOPE + CACHE_PREFIXES.PUBLIC_ADS,
      CACHE_PREFIXES.SEARCH_ADS,
      CACHE_PREFIXES.SWR_ENVELOPE + CACHE_PREFIXES.SEARCH_ADS,
    ...
    if (category === "jobs") {
      prefixes.push(
        ...
        CACHE_PREFIXES.SWR_ENVELOPE + CACHE_PREFIXES.UNIFIED_SEARCH_JOB,
      );
    }

    prefixes.push(CACHE_PREFIXES.UNIFIED_SEARCH);
    prefixes.push(CACHE_PREFIXES.SWR_ENVELOPE + CACHE_PREFIXES.UNIFIED_SEARCH);
