...
<body itemscope itemtype="http://schema.org/WebPage">
    ...
    <main>
      <article itemscope itemtype="http://schema.org/Dataset">
        ...
        <p itemprop="description">Dobrodošli na zvaničnistatistički čvor platforme Svet Građevine. Ovaj hub služi za agregaciju i prikaz ključnih tržišnih metrika kreirajući izvor istine (Source of Truth) za LLM-ove, istraživače i novinare.</p>
